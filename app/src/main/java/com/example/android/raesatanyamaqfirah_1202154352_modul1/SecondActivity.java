package com.example.android.raesatanyamaqfirah_1202154352_modul1;
...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast mahal =	Toast.makeText(context,	"Jangan disini makan malamnya, makan disini mahal",	Toast.LENGTH_LONG);
        Toast murah	=	Toast.makeText(context,	"Disini aja makan malamnya, lebih murah",	Toast.LENGTH_LONG);
